In this directory there is 3 examples written in RUBY showing how to use libcurl with [outscale's API](https://docs.outscale.com/api). All these examples use FFI. 
